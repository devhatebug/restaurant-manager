            ...
            <div className="h-full px-3 py-4 overflow-y-auto bg-gray-800">
               {isSidebarOpen === true && <button onClick={closeSiderBar} className="mb-[10px] right-[-40px] absolute">
                ...
                <div className="flex items-center ps-2.5 mb-5 cursor-pointer">
                    ...
                    <span className="self-center text-xl font-semibold whitespace-nowrap text-white">Adminstator</span>
                </div>
                <ul className="space-y-2 font-medium">
                    <li className="cursor-pointer">
                        <a href="/admin/dashboard" className="flex items-center p-2 text-white rounded-lg hover:bg-gray-700 group">
                    ...
                    <li className="cursor-pointer">
                        <div onClick={toogleFollow} className="flex items-center p-2 text-white rounded-lg hover:bg-gray-700 group">
                        ...
                        {isFollow === true &&
                            <ul className="text-sm max-w-md space-y-1 text-gray-400">
                                <li className="cursor-pointer hover:bg-gray-700 p-[5px] rounded-lg ml-[40px]">
                    ...
                    <li className="cursor-pointer">
                        <a href="/admin/product" className="flex items-center p-2 text-white rounded-lg hover:bg-gray-700 group">

      ...
      <div>
        {isWarning && (
          ...
          >
            ...
            <div>
              <span className="font-medium">Cảnh báo lỗi!</span> Kích thước ảnh không vượt quá 2mb
            </div>
          </div>
        )}
        {notiDupicate && (
          ...
          >
            ...
            <span className="sr-only">Info</span>
            <div>
              <span className="font-medium">Cảnh báo lỗi!</span> Tên người dùng
              đã được sử dụng
            </div>
          </div>
        )}
        {isReady && (
          ...
          >
            ...
            <span className="sr-only">Info</span>
            <div>
              <span className="font-medium">Cảnh báo lỗi!</span> Kông mục nào
              được để trống
            </div>
          </div>
        )}
